<x-app-layout>
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-2xl font-semibold mb-6">Registrar Ítem de Mano de Obra</h1>

            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <form action="{{ route('mano.obra.contrato.store', $proyecto) }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="descripcion" value="{{ old('descripcion') }}" 
                            ...
                            placeholder="Ej: Albañilería, Carpintería estructural..." required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="unidad" value="{{ old('unidad') }}" 
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            placeholder="Ej: Hombre-hora, m², und" required>
