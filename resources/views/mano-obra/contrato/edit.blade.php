<x-app-layout>
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-2xl font-semibold mb-6">Editar Ítem de Mano de Obra</h1>

            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <form action="{{ route('mano.obra.contrato.update', [$proyecto, $manoObraContrato]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="descripcion" value="{{ old('descripcion', $manoObraContrato->descripcion) }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="unidad" value="{{ old('unidad', $manoObraContrato->unidad) }}" 
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="cantidad" value="{{ old('cantidad', $manoObraContrato->cantidad) }}" step="0.01" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="precio_unit" value="{{ old('precio_unit', $manoObraContrato->precio_unit) }}" step="0.01" min="0"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            required>
                    ...
                    <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        <p class="text-sm text-gray-600 dark:text-gray-300">
                            ...
                            <span id="total-preview" class="font-semibold">
                                Bs {{ number_format($manoObraContrato->monto_presupuestado, 2) }}
                            </span>
                        </p>
                    </div>
