 <x-app-layout>
    <div class="py-3">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-2xl font-semibold mb-4 px-8">Editar Proyecto</h1>
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl">
                            <form action="{{ route('proy.store') }}" method="POST">
                                    ...
                                    >
                                        @foreach($residentes as $residente)
                                            <option value="{{ $residente->id }}" 
                                                {{ in_array($residente->id, old('residentes_ids', [])) ? 'selected' : '' }}>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="{{ url()->previous() }}" class="px-6 py-2 bg-red-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition duration-150 ease-in-out">
                                        Cancelar
                                    </a>
                                </div>
                            </form>
