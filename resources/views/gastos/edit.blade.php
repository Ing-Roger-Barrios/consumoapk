            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <form action="{{ route('gastos.update', [$proyecto, $gasto]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="monto" value="{{ old('monto', $gasto->monto) }}" step="0.01" min="0.01"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="fecha_gasto" value="{{ old('fecha_gasto', $gasto->fecha_gasto->format('Y-m-d')) }}" 
                               max="{{ date('Y-m-d') }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                               required>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            {{ $gasto->comprobante ? 'Reemplazar comprobante' : 'Subir comprobante' }}
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="notas" rows="3"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            placeholder="Detalles adicionales...">{{ old('notas', $gasto->notas) }}</textarea>
