...
=======
                <h1 class="text-2xl font-semibold">Equipo y Maquinaria de Contrato - {{ $proyecto->nombre }}</h1>
                    ...
                    <table class="min-w-[600px] w-full text-left dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($equipos as $equipo)
                                <tr>
                                    <a href="{{  route('equipo.ejecucion.index', $proyecto)}}">
                                    <td class="px-6 py-4 font-medium">{{ $equipo->descripcion }}</td></a>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('equipo.contrato.edit', [$proyecto, $equipo]) }}" 
                                           class="text-yellow-500 hover:text-yellow-600 mr-3">
                                            Editar
                                        </a>
                                        <form action="{{ route('equipo.contrato.destroy', [$proyecto, $equipo]) }}" 
                                              method="POST" 
                                              class="inline"
