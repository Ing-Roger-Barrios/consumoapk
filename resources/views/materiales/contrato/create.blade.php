<x-app-layout>
    <div class="py-3">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-2xl font-semibold mb-6">Registrar Material de Contrato</h1>

            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <form action="{{ route('materiales.contrato.store', $proyecto) }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="descripcion" value="{{ old('descripcion') }}" 
                            ...
                            placeholder="Ej: Cemento Tipo I, Arena fina..." required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="unidad" value="{{ old('unidad') }}" 
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            placeholder="Ej: Bolsa, m³, kg, Lt" required>
                    ...
                    <!-- Total (calculado automáticamente, solo informativo) -->
                    <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        <p class="text-sm text-gray-600 dark:text-gray-300">
                            <strong>Total estimado:</strong> 
                            <span id="total-preview" class="font-semibold">Bs {{ number_format(old('cantidad', 0) * old('precio_unit', 0), 2) }}</span>
                        </p>
                    </div>
